...
//drawWinLine function is callled to draw line if condition is memt.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        ...
        c.moveTo(x1, y1);
        //This method indictaes the end point in our line.
        c.lineTo(x, y);
        ...
        if (x1 <= x2 && y1 <= y2) {
                ...
                if (y < y2) { y +=10; }
                //This consition cancels our animation loop if reach the end points.
                if (x >= x2 && y >= y2) { cancelAnimationFrame(animationLoop);}
        }
        //This condition is similar to the one above.
        //It was nedessary for the 6, 4, 2 win condition.
        if (x1 <= x2 && y1 >= y2) {
            if (x < x2) { x += 10; }
            if (y > y2) { y -= 10; }
            if (x >= x2 && y <= y2) { cancelAnimationFrame(animationLoop); }
